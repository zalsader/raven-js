...
* BUGFIX: `Raven.uninstall` now restores original builtin functions (e.g. setTimeout). See: https://github.com/getsentry/raven-js/issues/228
* CHANGE: `maxMessageLength` defaults to 0 (no limit). See: https://github.com/getsentry/raven-js/pull/441
